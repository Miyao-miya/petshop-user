...
<template>
    <div class="top">
        <!--        标题-->
        <h3 style="text-align: center; margin-top: 2%">我的相册</h3>
                ...
                <el-tabs v-model="display" @tab-click="handleClick">
                    ...
                    <el-tab-pane v-for="(item, index) in moduleData"
                        ...
                        <PostsA v-for="(items, indexs) in item.content"
                                ...
                                :key="index+indexs"
                                class="posts-module"
                                @click.native="photosModule(items)"/>
                        ...
                        <el-button type="success" plain
                                   ...
                                   class="posts-module-button-right">添加相册
                        </el-button>
        ...
        <el-dialog
            ...
            <!--            <span>需要下架相册吗</span>-->
            <PhotoModule v-bind:photo="photos"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            photosModule(moduleData) {
                this.dialogVisible = true
                let _this = this
                console.log(moduleData)
                _this.$api.photosApi.select(moduleData.pid).then(res => {
                    _this.photos = res
                })
            },
            ...
            postsModuleButton(index) {
                ...
                for (let i = 0; i < tab.length; i++) {
                    if (tab[i].innerText = '最新上传') {

                        this.postsOm()
                    } else if (tab[i].innerText = '最多点赞') {
                        this.postsLm()

                    } else if (tab[i].innerText = '收藏最多') {
                        this.postsCm()
            ...
            postsOm() {
                ...
                //帖子基本信息    最新发布
                _this.$api.photosApi.findAllByFkUId(window.sessionStorage.getItem('pkId'), pages.nexts, pages.sizes).then(res => {
                    if (res != null) {
            ...
            postsLm() {
                ...
                //帖子基本信息    最多点击
                _this.$api.photosApi.findAllByFkUIdGroupLike(window.sessionStorage.getItem('pkId'), pages.nexts, pages.sizes).then(res => {
                    if (res != null) {
            ...
            postsCm() {
                ...
                //帖子基本信息    最多收藏
                _this.$api.photosApi.findAllByFkUIdGroupCollect(window.sessionStorage.getItem('pkId'), pages.nexts, pages.sizes).then(res => {
                    if (res != null) {
        ...
        created() {
            ...
            //帖子基本信息    最新发布
            _this.$api.photosApi.findAllByFkUId(window.sessionStorage.getItem('pkId'), 1, 5).then(res => {
                if (res != null) {
            ...
            //帖子基本信息    最多点击
            _this.$api.photosApi.findAllByFkUIdGroupLike(window.sessionStorage.getItem('pkId'), 1, 5).then(res => {
                if (res != null) {
            ...
            //帖子基本信息    最多收藏
            _this.$api.photosApi.findAllByFkUIdGroupCollect(window.sessionStorage.getItem('pkId'), 1, 5).then(res => {
                if (res != null) {
